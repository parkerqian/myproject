...
def waitForLogin():
	...
	if code == '201':
		print 'scan success ,and click phone to login '
		tip = 0
	elif code == '200':
		print 'logining...'
...
def main():
	...
	MemberCount = len(MemberList)
	print 'your contract hava %s friends' % MemberCount
	...
	for i in xrange(0, int(math.ceil(MemberCount / float(MAX_GROUP_NUM)))):
		...
		print 'find %s friends deleted' % DeletedCount
		# raw_input()
